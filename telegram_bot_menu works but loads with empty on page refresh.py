...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="miniPlayer" class="mini-player" hidden>
                <div class="mini-player-content">
                    <div class="mini-player-track">
                        <div class="mini-player-title-section">
                            <span id="miniPlayerTitle" class="clickable-title" title="Click to select track">♪ Ready to play</span>
                            <button id="miniPlayerDropdown" class="dropdown-btn" title="Select track">⌄</button>
                        </div>
            ...
            <div id="trackSelectorModal" class="track-selector-modal" hidden>
        ...
        const playlist = {
            ...
            updateMiniPlayer() {
                ...
                if (this.tracks.length > 0) {
                    ...
                    // If no current track is selected, show the most recent one
                    if (this.currentIndex < 0 || this.currentIndex >= this.tracks.length) {
                        ...
                        if (miniPlayerDuration) miniPlayerDuration.textContent = '0:00';
