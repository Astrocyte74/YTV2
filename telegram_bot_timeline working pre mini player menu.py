    ...
    <script>
        ...
        const playlist = {
            ...
            updateMiniPlayer() {
                ...
                // Only show mini player if we have an active track AND it has been played at least once
                if (this.currentAudio && this.currentIndex >= 0 && this.currentIndex < this.tracks.length && this.hasStartedPlaying) {
                    const track = this.tracks[this.currentIndex];
