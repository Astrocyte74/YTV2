...
class AudioDashboard {
    ...
    renderChip(text, type = 'category', small = false, parent = null) {
        const base = small ? 'text-[10px] px-3 py-1' : 'text-sm px-4 py-2 tracking-wide';
