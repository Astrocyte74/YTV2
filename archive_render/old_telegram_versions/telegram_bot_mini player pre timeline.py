    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        @media (max-width: 768px) {{
            ...
            .refresh-btn {{ bottom: 20px; left: 20px; }}
        }}
        ...
        .mini-player-track span:last-child {{
            font-size: 11px;
            opacity: 0.8;
        }}
        ...
        <div class="content">
            ...
            <div class="toolbar">
                <div class="toolbar-left">
                    ...
                    <button id="btnPlaylist" aria-controls="playlistDrawer" aria-expanded="false">
                        🎵 Playlist
                        <span class="playlist-badge" id="playlistBadge" style="display: none;">0</span>
                    </button>
                </div>
            ...
            <div id="miniPlayer" class="mini-player" hidden>
                <div class="mini-player-track">
                    <span id="miniPlayerTitle">♪ Ready to play</span>
                    <span id="miniPlayerProgress">0:00 / 0:00</span>
                </div>
    ...
    <script>
        ...
        const playlist = {
            ...
            updateMiniPlayer() {
                ...
                if (this.currentAudio && this.currentIndex >= 0 && this.currentIndex < this.tracks.length) {
                    const track = this.tracks[this.currentIndex];
