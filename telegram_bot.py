    ...
    def do_GET(self):
        ...
        try:
            ...
            if filename == 'health':
                ...
                self.end_headers()
                health_response = '{"status": "healthy", "service": "ytv2-telegram-bot"}'
...
class YouTubeTelegramBot:
    ...
    def __init__(self, token: str, allowed_user_ids: List[int]):
        ...
        # Use Render's PORT env var first, then WEB_PORT, default to 6452 for local dev
        default_port = int(os.getenv('PORT', os.getenv('WEB_PORT', '6452')))
