...
class YouTubeSummarizer:
    ...
    async def generate_summary(self, transcript: str, metadata: Dict, 
        ...
        prompts = {
            ...
            **EXECUTIVE SUMMARY**
            Write 2-3 sentences capturing the video's main purpose, key findings, and practical value. Use a professional, analytical tone.

            **KEY INSIGHTS & ANALYSIS** 
            Divide the content into 2-4 natural sections with **descriptive headings** (not "Part 1/2/3"). For each section:
            - Start with 2-3 sentences explaining the focus and relevance  
            - Include 3-5 specific findings or key points as bullets
            - End with 1-2 sentences on strategic implications

            **STRATEGIC RECOMMENDATIONS**
            Provide 3-4 actionable takeaways or next steps based on the analysis.

            **Writing Guidelines:**
            - Assume audience is senior leadership or decision-makers — concise, high-value, no filler
            - Focus on insights and implications, not just facts
            - Use professional language (British/Canadian spelling)
            - Include timestamps sparingly, only where they strengthen the narrative
            - Vary your section introductions naturally 
            - Only create sections that fit the content naturally
            - Never speculate beyond what's presented
            - Make it sound executive-authored, not template-generated
            """,
