    ...
    if result.returncode == 0:
        for line in result.stdout.splitlines():
            if '=' in line:
                ...
                if key.startswith(('LLM_', 'OPENAI_', 'ANTHROPIC_', 'OPENROUTER_', 'HUME_')):
                    os.environ[key] = value
except Exception:
    pass  # Fallback to regular .env loading

# Debug: Print if HUME_API_KEY is loaded
hume_key = os.getenv('HUME_API_KEY')
if hume_key:
    print(f"✅ HUME_API_KEY loaded: {hume_key[:10]}...")
else:
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            # Add audio player section if audio file exists
            if audio_filepath and summary_type == "audio":
            ...
            <div class="audio-section">
                ...
                <div class="audio-info">
                    🎵 Generated with Hume AI • Perfect for listening on-the-go
                </div>
            </div>
            """
...
Please try again with a different video or contact support if the issue persists."""
            ...
            if summary_type == "audio":
                ...
                if summary_text:
                    ...
                    audio_filepath = self.summarizer.generate_tts_audio(summary_text, audio_filename)
                    if audio_filepath:
