...
class YouTubeSummarizer:
    ...
    async def generate_summary(self, transcript: str, metadata: Dict, 
        ...
        prompts = {
            ...
            **EXECUTIVE SUMMARY**
            Write 2–3 concise sentences capturing the video's main purpose, key findings, and practical value. Keep it sharp and high-level — no more than 3 sentences.

            **KEY INSIGHTS & ANALYSIS**
            Organise the content into 2–4 natural sections with **short, descriptive headings** (aim for 2–5 words, not long clauses). For each section:
            - Begin with 1–2 sentences summarising the focus and relevance  
            - Present 3–5 key findings as **uniform, scannable bullets** (short phrases or one-liners, not full paragraphs)  
            - End with 1–2 sentences highlighting the implications  

            **STRATEGIC RECOMMENDATIONS**
            Provide 3–4 clear, actionable recommendations in a **tiered bullet format**:  
            - Top-level bullet = concise headline (e.g., *Institutionalise cost governance*)  
                • Supporting bullet(s) = 1–2 clarifying details  

            **Writing Guidelines:**
            - Assume the audience is senior leadership or decision-makers — concise, high-value, no filler
            - Focus on insights and implications, not just facts
            - Use professional language (British/Canadian spelling)
            - Include timestamps sparingly, only if they clarify context
            - Vary section introductions naturally (avoid repetitive phrasing)
            - Only create sections that fit the content naturally
            - Never speculate beyond what's presented
            - Aim for natural flow and readability — the report should feel human-authored, not template-generated
            """,
