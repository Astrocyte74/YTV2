    ...
    async def generate_summary(self, transcript: str, metadata: Dict, 
        ...
        prompts = {
            ...
            **Writing Guidelines:**
            ...
            Create an audio-optimized summary designed for text-to-speech playback. Write in natural, spoken language that flows smoothly when read aloud.

            **Structure (as flowing speech, 180-250 words):**
            
            **Opening** (1-2 sentences): Natural spoken introduction
            - "This video covers..." or "In this video, [speaker] explains..."
            - State the main topic and why it's worth listening to
            
            **Key Content** (3-4 sentences): Core information in speech-friendly format
            - Use "First," "Next," "Additionally" as natural transitions
            - Include specific details, numbers, or steps mentioned
            - Avoid timestamps (not useful in audio format)
            - Use "around [X] minutes in" instead if timing context is crucial
            
            **Practical Value** (2-3 sentences): Real-world application
            - "What this means for you is..."
            - "The practical takeaway here is..."
            - Focus on actionable insights
            
            **Conclusion** (1-2 sentences): Clear wrap-up
            - "The key point to remember is..."
            - End with the single most important insight
