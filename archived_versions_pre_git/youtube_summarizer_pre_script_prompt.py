...
class YouTubeSummarizer:
    ...
    async def generate_summary(self, transcript: str, metadata: Dict, 
        ...
        prompts = {
            ...
            **Content Focus (comprehensive but concise for audio):**
            ...
            - **Cover all major sections** - don't skip important topics like build quality, specifications, pricing, or final recommendations
            - **Include specific details and numbers** - model names, prices, measurements, test results
            - **Use natural speech transitions** but focus on substance: "The main finding is...", "Key results show...", "Performance-wise..."
            - **Scale appropriately to content** - brief summaries for simple topics, comprehensive coverage for detailed reviews
            - **End with practical implications and recommendations** - what should listeners actually know or do?
