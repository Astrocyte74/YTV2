        ...
        <div class="controls-bar">
                <div class="controls-row">
                    ...
                    <div class="controls-group">
                        ...
                        <select id="modelFilter" class="control-select" onchange="filterByModel()">
            ...
            index_html += """</select>
                        <button onclick="selectAll()" class="btn btn-outline">Select All</button>
                        <button onclick="deleteSelected()" class="btn btn-danger" id="deleteBtn" disabled>🗑️ Delete</button>
                        <div class="controls-group">
                            <span style="color: #6c757d; font-size: 14px;">⬇ Export:</span>
                            <button class="btn btn-outline btn-sm">PDF</button>
                            <button class="btn btn-outline btn-sm">MD</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            if html_files:
                ...
                for file_path in html_files:
                    ...
                    if thumbnail_url:
                        ...
                        <div class="thumbnail-fallback" style="display: none;">📺</div>'''
                    else:
                        thumbnail_html = '<div class="thumbnail-fallback">📺</div>'
