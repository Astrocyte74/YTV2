                ...
                <div class="controls-row">
                    ...
                    <div class="controls-group">
                        ...
                        <div class="filter-chips">
                            <button class="filter-chip active" data-filter="all" onclick="filterByChip(this, 'all')">All</button>"""
                    
            # Add model filter chips dynamically
            for model, count in sorted(model_usage.items()):
                # Get model badge text for cleaner chip display
                chip_text = model.split('/')[-1].split('-')[0].upper()[:8] if '/' in model else model.upper()[:8]
                index_html += f'<button class="filter-chip" data-filter="{model}" onclick="filterByChip(this, \'{model}\')">{chip_text}</button>'
            ...
            <div class="video-info">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{processor_info.get('llm_provider', 'Unknown').title()}</div>
                    </div>
                    <div class="info-item">
