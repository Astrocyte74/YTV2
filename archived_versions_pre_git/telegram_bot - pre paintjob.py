                ...
                <div class="report-card" data-title="{display_name}" data-time="{mtime.timestamp()}" data-filename="{file_path.name}" data-model="{used_model}" data-summary-type="{summary_type}">
                    ...
                    <div class="report-meta">
                        <div class="report-meta-item">
                            <span>🕒</span> <span class="report-meta-value">Generated {time_ago}</span>
                        </div>
                        <div class="report-meta-item">
                            <span>📅</span> <span class="report-meta-value">{time_str}</span>
                        </div>
                        <div class="report-meta-item">
                            <span>🤖</span> <span class="report-meta-value">{used_model}</span>
                        </div>
                        <div class="report-meta-item">
                            <span>📝</span> <span class="report-meta-value">{summary_type}</span>
                        </div>"""
                    
                    if youtube_url:
                        index_html += f"""
                        <div class="report-meta-item">
                            <span>📺</span> <span class="report-meta-value"><a href="{youtube_url}" target="_blank" style="color: #ff0000; text-decoration: none;">YouTube Video</a></span>
                        </div>"""
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleScroll() {
                ...
                if (currentScrollY > 100) {
                    managementControls.classList.add('scrolled');
                } else {
                    managementControls.classList.remove('scrolled');
                }
